...
export const Privacy = () => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to heatmap-creator, 158 India St,
            Brooklyn NY 11222.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to heatmap-creator, accessible from{" "}
            <a
              href="https://getheatmap-creator.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://getheatmap-creator.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: help@getheatmap-creator.app</li>
      </ul>
    </div>
  );
};
